    ...
    <nav class="navbar navbar-inverse">
		...
		<div class="container-fluid">
			...
			<div class="navbar-header">
				<a href="index.php" class="navbar-brand" /> ABS LIBRARY MANAGEMENT SYSTEM </a>
    ...
    <div class="row">
		...
		<div class="col-xs-4" style="background-color:rgba(202, 205, 205, 0.100) ">
			...
			<input type="text" class="form-control" name="name"  placeholder="User Name" aria-describedby="basic-addon1" required ><br/><br/>
						...
						<input type="text" class="form-control" name="address"  placeholder="Address" aria-describedby="basic-addon1" required > <br/><br/>

			<input type="text" class="form-control" name="mobile"  placeholder="Enter Mobile Number" aria-describedby="basic-addon1" required > <br/><br/>
